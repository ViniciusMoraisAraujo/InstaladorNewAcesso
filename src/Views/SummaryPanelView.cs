...
public static class SummaryPanelView
{
    ...
    public static void Exibir()
    {
        ...
        var panel = new Panel(new Markup(string.Join(Environment.NewLine, content)))
            .Header("[bold yellow]📊 RESUMO DA INSTALAÇÃO[/]")
    ...
    /// </summary>
    public static void ExibirEtapa(string etapa, string emoji, List<SummaryResult> resultadosDaEtapa)
    {
        ...
        var panel = new Panel(new Markup(string.Join(Environment.NewLine, lines)))
            .Header($"[bold cyan]{emoji} {etapa.EscapeMarkup()}[/]")
            .Border(BoxBorder.Rounded)
